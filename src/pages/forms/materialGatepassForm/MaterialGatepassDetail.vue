...
const headerDate = computed(() => {
    // prefer doc_date; fallback created_at
...
const docDateOnly = computed(() => data.value?.doc_date ? dayjs(data.value.doc_date).format('DD/MM/YYYY') : '')
...
const step2View = computed(() => viewOf(2)) // GĐX/HCNS
...
/* NEXT APPROVER (nếu chưa phải bước cuối) */
